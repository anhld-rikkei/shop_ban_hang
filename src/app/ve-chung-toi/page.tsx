...
export default async function AboutPage() {
  ...
  return (
    <SiteChrome>
      <PageBand title="Về chúng tôi" crumbs={[{ label: "Về chúng tôi" }]} description="LienStore – hàng Nhật nội địa, mua tận tay tại Nhật, có bill cho từng đơn." />
      <FullWidthShell>
        <div className="mx-auto max-w-[1000px]">
          {/* Story */}
          <section className="grid gap-8 md:grid-cols-[1.4fr_1fr] md:items-start">
            <div className="text-[15px] leading-7 text-lien-text">
              <h2 className="m-0 mb-3 text-[22px] font-bold leading-8 text-lien-heading">LienStore ra đời từ một nỗi lo rất thật</h2>
            ...
            <aside className="rounded-md border border-lien-line bg-lien-cream p-5 text-[14px] leading-6">
              <h3 className="m-0 mb-3 text-[15px] font-bold uppercase text-lien-heading">Quy trình 5 bước</h3>
          ...
          <section id="lien-he" className="mt-12 scroll-mt-24" aria-labelledby="lien-he-title">
            ...
            <p className="m-0 mb-6 text-center text-[14px] text-lien-muted">Trả lời nhanh nhất qua Zalo trong giờ {contact.hours} (giờ Việt Nam).</p>
            <div className="grid gap-4 md:grid-cols-3">
              <div className="rounded-md border border-lien-line bg-white p-5">
                <h3 className="m-0 mb-3 text-[13px] font-bold uppercase tracking-[0.3px] text-lien-heading">Điện thoại & Zalo</h3>
                <ul className="m-0 list-none space-y-2 p-0 text-[14px]">
                  {contact.phones.map((p) => (
                    <li key={p.number} className="flex items-center gap-2">
                      ...
                      <span className="text-lien-muted">Hotline {p.label}:</span>
              ...
              <div className="rounded-md border border-lien-line bg-white p-5">
                <h3 className="m-0 mb-3 text-[13px] font-bold uppercase tracking-[0.3px] text-lien-heading">Địa chỉ & giờ làm việc</h3>
                <p className="m-0 flex items-start gap-2 text-[14px] leading-6 text-lien-text">
                  ...
                  <span>
                    Kho hàng Việt Nam: {contact.address}
                    <br />
                    Điểm mua hàng: Nhật Bản
                  </span>
                </p>
                <p className="m-0 mt-2 flex items-center gap-2 text-[14px] text-lien-text">
                  <Fa name="clock-o" className="text-lien-blue" /> {contact.hours} hằng ngày
                </p>
              </div>
              <div className="rounded-md border border-lien-line bg-white p-5">
                <h3 className="m-0 mb-3 text-[13px] font-bold uppercase tracking-[0.3px] text-lien-heading">Mạng xã hội</h3>
                <ul className="m-0 list-none space-y-2 p-0 text-[14px]">
